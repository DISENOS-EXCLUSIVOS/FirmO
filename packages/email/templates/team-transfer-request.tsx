...
export const TeamTransferRequestTemplate = ({
  ...
  const previewText = 'Aceptar solicitud de transferencia de equipo en FirmO';
            ...
            <Container className="mx-auto mb-2 mt-8 max-w-xl rounded-lg border border-solid border-slate-200 px-2 pt-2 backdrop-blur-sm">
              ...
              <Section className="p-2 text-slate-500">
                <Text className="text-center text-lg font-medium text-black">
                  {teamName} solicitud de transferencia de propiedad
                </Text>

                <Text className="my-1 text-center text-base">
                  <span className="font-bold">{senderName}</span> ha solicitado que usted tome
                  propiedad del siguiente equipo
                </Text>
                ...
                <Text className="text-center text-sm">
                  Al aceptar esta solicitud, usted será responsable de cualquier elemento asociado
                  con este equipo.
                </Text>
              ...
              <Text className="text-center text-xs">El enlace caduca en 1 hora.</Text>
            </Container>
