  ...
  return (
    <div className={cn('relative max-w-[100vw] overflow-hidden')}>
      ...
      <div className="container mx-auto flex h-full min-h-screen items-center px-6 py-32">
        <div>
          <p className="text-muted-foreground font-semibold">404 Página no encontrada</p>

          <h1 className="mt-3 text-2xl font-bold md:text-3xl">¡Ups! Algo salió mal.</h1>

          <p className="text-muted-foreground mt-4 text-sm">
            La página que busca fue movida, eliminada, renombrada o es posible que nunca haya
            existido.{' '}
          </p>
